  ...
  return (
    <header className="bg-slate-900 text-white shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-3">
        ...
        >
          <div className="relative flex items-center justify-center w-11 h-11 rounded-lg bg-red-600 shadow-md overflow-hidden flex-shrink-0 group-hover:bg-red-700 transition-colors">
            {logoUrl ? (
          ...
          <div className="flex flex-col min-w-0 text-left">
            <h1 className="text-lg sm:text-xl font-bold tracking-tight leading-tight truncate group-hover:text-red-300 transition-colors">
              {companyName}
            </h1>
